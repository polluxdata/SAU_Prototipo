...
<html>
  ...
  <body>
    ...
    <script>
       ...
       */
      d3.json('geoio.php', function(error, json) {
        var features = topojson.feature(json,json.features);
        ...
        var canvasFunction = function(extent, resolution, pixelRatio,
          ...
          var geoBoundsLeftBottom = ol.proj.transform(
              geoBounds[0], 'EPSG:32717', projection);
          var geoBoundsRightTop = ol.proj.transform(
              geoBounds[1], 'EPSG:32717', projection);
